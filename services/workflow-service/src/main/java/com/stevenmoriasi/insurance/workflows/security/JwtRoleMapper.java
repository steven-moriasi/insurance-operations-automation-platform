package com.stevenmoriasi.insurance.workflows.security;
...
final class JwtRoleMapper implements Converter<Jwt, Collection<GrantedAuthority>> {

    private final String clientId;
    private final JwtGrantedAuthoritiesConverter scopes = new JwtGrantedAuthoritiesConverter();

    JwtRoleMapper(String clientId) {
